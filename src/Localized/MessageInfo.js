...
export const MSGSteateInfo={Quality:{TH:'โปรดให้คะแนนคุณภาพบริการ',EN:'Please rate our service.',isActive:true},
...
export const SendInfo={provider_report_call_success:'บอกว่า call สำเร็จมั้ย',
...
export const FeedbackInfo={rating:true,
                           problem:'not_completed',
                           problem_other:'',
                          }